...
def cart_detail(request, total=0, counter=0, cart_items=None):
    ...
    description = 'Crossroads Books - New Order'
    ...
    if request.method == 'POST':
        try:
            ...
            billingPincode = request.POST['stripeBillingAddressZip']
            billingCountry = request.POST['stripeBillingAddressCountryCode']
            shippingName = request.POST['stripeShippingName'] 
            shippingAddress1 = request.POST['stripeShippingAddressLine1']
            shippingCity = request.POST['stripeShippingAddressCity']
            shippingPincode = request.POST['stripeShippingAddressZip']
    ...
    return render(request,'cart.html',context={'cart_items':cart_items,'total':total, 'counter':counter,'data_key':data_key, 'stripe_total':stripe_total, 'description':description})     
...
def thanks_page(request, order_id):
    ...
    return render(request,'thankyou.html',context={'customer_order':customer_order})
...
def orderHistory(request):
    ...
    return render(request,"orders.html",context={"order_details":order_details})
